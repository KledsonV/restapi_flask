...
class User(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            result.save()
            return {"statusCode": 201, "message": "User created success."}, 201
        ...
        #                 "CPF already exists in database."}, 400
            ...
            return {"statusCode": 500, "message": "An unexpected error occurred."}, 500
    ...
    def patch(self):
        ...
        if not UserModel.objects(cpf=data["cpf"]).first():
            return {"statusCode": 400, "message": "CPF not exists in database."}, 400
        if UserModel.objects(email=data["email"]).first():
            return {
                "statusCode": 400,
                "message": "Email already exists in database.",
        ...
        try:
            ...
            return {"statusCode": 200, "message": "User updated success."}, 200
        # except NotUniqueError:
        #     return {"statusCode": 400,
        #             "message":
        #                 "CPF already exists in database."}, 400
